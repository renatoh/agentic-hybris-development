...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/customcore/import/common/essential-data.impex");
		importImpexFile(context, "/customcore/import/common/countries.impex");
		importImpexFile(context, "/customcore/import/common/delivery-modes.impex");
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		processCockpit(context, importAccessRights, extensionNames, "cmsbackoffice",
				"/customcore/import/cockpits/cmscockpit/cmscockpit-users.impex",
				"/customcore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");

		processCockpit(context, importAccessRights, extensionNames, "productcockpit",
				"/customcore/import/cockpits/productcockpit/productcockpit-users.impex",
				"/customcore/import/cockpits/productcockpit/productcockpit-access-rights.impex",
				"/customcore/import/cockpits/productcockpit/productcockpit-constraints.impex");

		processCockpit(context, importAccessRights, extensionNames, "customersupportbackoffice",
				"/customcore/import/cockpits/cscockpit/cscockpit-users.impex",
				"/customcore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
	}
