...
<spring:url value="/my-account/customerCouponClaim" var="claimCustomerCouponAction"/>
<c:set var="searchUrl"
...
<div style="display:none">
 <div id="claimCustomerCouponForm">
  <form:form id="claimCouponForm" action="${claimCustomerCouponAction}" method="post" modelAttribute="couponForm">
    <div class="form-group">
    	<label class="control-label">Coupon Code</label>
		  <input id="customerCouponCode" name="couponCode" class="text form-control" type="text" placeholder="Enter the coupon code to claim a coupon"/>
	</div>
	<div class="row">
      <div class="col-sm-6 col-sm-push-6">
        <div class="couponCodeSectionsActions">
           <button type="submit" id="claimCouponButton" class="btn btn-primary btn-block">
               <spring:theme code="text.account.claimCoupon.popup.action"/>
            </button>
        </div>
      </div>
      <div class="col-sm-6 col-sm-pull-6">
         <div class="couponCodeSectionsActions">
              <button type="button" id="resetCoupon" class="btn btn-default btn-block">
               <spring:theme code="text.account.resetCoupon.popup.action"/>
              </button>
         </div>
      </div>
      </div>
...
<script type="text/javascript">
  ...
  {
    ACC.customerCoupon.handleClaimCouponByClick()
   });
</script>
