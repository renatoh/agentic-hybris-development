...
public class RegistrationValidator implements Validator
{
	...
	public void validate(final Object object, final Errors errors)
	{
		...
		if (registerForm.isOtpForRegistrationEnabled())
		{
			final String verificationTokenCode = registerForm.getVerificationTokenCode();
			validateVerificationTokenCode(errors, verificationTokenCode);
		}
	...
	protected void validateVerificationTokenCode(final Errors errors, final String verificationTokenCode)
	{
		if (StringUtils.isBlank(verificationTokenCode))
		{
			errors.rejectValue("verificationTokenCode", "register.verificationTokenCode.invalid");
		}
	}
}
