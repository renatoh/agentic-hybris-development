...
import de.hybris.platform.customercouponaddon.forms.CustomerCouponClaimForm;
...
public class CustomerCouponsPageController extends AbstractSearchPageController
{
	 ...
	 * @param redirectModel
	 * @return
	 * @deprecated since 2211.34 - use{@link #claimCustomerCouponAction(CustomerCouponClaimForm, BindingResult, HttpServletRequest, RedirectAttributes)}
	 */
	@Deprecated(since = "2211.34", forRemoval = true)
	@RequireHardLogIn
	...
	@RequireHardLogIn
	@PostMapping(value = "/customerCouponClaim")
	public String claimCustomerCouponAction(@Valid final CustomerCouponClaimForm form, final BindingResult bindingResult,
			final HttpServletRequest request, final RedirectAttributes redirectAttributes)
	{
		addFlashMessage(customerCouponFacade.grantCouponAccessForCurrentUser(form.getCouponCode()), redirectAttributes);
