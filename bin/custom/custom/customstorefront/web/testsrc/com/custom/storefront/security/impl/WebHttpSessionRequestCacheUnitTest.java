...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/customstorefront/electronics/en",
						"https://electronics.local:9002/customstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/customstorefront/electronics/en",
						"https://electronics.local:9002/customstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/customstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/customstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/customstorefront/electronics/en",
						"https://electronics.local:9002/customstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/customstorefront",
						"https://electronics.local:9002/customstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/customstorefront",
						"https://electronics.local:9002/customstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/customstorefront/electronics/en",
						"https://electronics.local:9002/customstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
