 ...
 */
package com.custom.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CustomFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CustomFulfilmentProcessConstants.PARENT_PROCESS);
