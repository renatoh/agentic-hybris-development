 ...
 */
package com.custom.fulfilmentprocess.actions.order;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(CustomFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimitExternal"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(CustomFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreToleranceExternal"));
